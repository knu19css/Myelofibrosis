...
ggsave(p, filename = paste0("GSE196676/features3/0_Umap.png"), dpi = 300)

for (i in 1:length(is)) {
  temp1 <- VlnPlot(data, features = is[[i]], stack = T)
  ggsave(temp1, filename = paste0("GSE196676/features3/", i, "_VlnPlot_", names(is)[i], ".png"), dpi = 300)
  ...
  ggsave(temp2, filename = paste0("GSE196676/features3/", i, "_Ft_", names(is)[i], ".png"), dpi = 300)
}
...
DoHeatmap(data, features = markergenes)
